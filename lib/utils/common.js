...
exports.readModuleEnv = readModuleEnv;
...
function isURL(str, absolute = false) {
...
function retry(operation, retries = 0) {
    async function doOp(attempt) {
        try {
...
exports.md5 = md5;
exports.validPkgNameRegEx = /^(@[-_\.a-z\d]+\/)?[-_\.a-z\d]+$/i;
exports.validAliasRegEx = /^[@\-_\.a-z\d\/]+$/i;
