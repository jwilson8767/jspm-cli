...
const package_json_file_1 = __importDefault(require("./package-json-file"));
const jspm_file_1 = __importDefault(require("./jspm-file"));
const global_config_file_1 = __importDefault(require("./global-config-file"));
